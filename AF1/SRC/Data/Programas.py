...
def Guardar():
	...
	if(Opcion == 'S' or Opcion == 's'):
		try:
			print('\n(i) - Que nombre le damos a la imagen?')
...
#Seleccion de imagen
Tkinter.Tk().withdraw() 
ruta = tkFileDialog.askopenfilename(filetypes=("Archivos JPG", "*.jpg","Archivos JPEG", "*.jpeg","Archivos PNG", "*.png","Todo los archivos", "*.*"))
