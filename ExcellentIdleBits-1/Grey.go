...
var (
	...
	MapaPal = map[color.Color]color.Color{
		...
		color.RGBA{255,255,  0,255}:color.RGBA{255,255,255,255},//amarillo
		...
		color.RGBA{255,255,255,255}:color.RGBA{255,255,255,255},//blanco	
	}
	g uint32
...
*/
func GreyMat(In string) image.Image{
	file, err := os.Open(In)
	if err != nil {
		log.Fatal(err)
	}
